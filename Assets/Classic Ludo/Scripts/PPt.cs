...
public class PPt : MonoBehaviour
{
    ...
    void ResetToBasePoint(PP playerPiece_)
    {
        Debug.Log(playerPiece_.name);

        if (playerPiece_.name == "Red")
        {
        ...
        else if (playerPiece_.name == "Green")
        {
        ...
        else if (playerPiece_.name == "Yellow")
        {
        ...
        else if (playerPiece_.name == "Blue")
        {
    ...
    private void ArrangePiecesInGrid()
    {
        ...
        float spacing = 0.2f;
        float yOffset = 0.06f; // Adjust this value to move the grid up or down
