...
public class cameraControllerScriptForBatsman : MonoBehaviour
{
    public static cameraControllerScriptForBatsman instance;
    ...
    void Start()
    {
        ...
        bowlerCamera = BowlermanagerForBatsman.instance.BowlerCamera;
